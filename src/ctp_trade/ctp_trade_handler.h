...
{
private:
    CThostFtdcTraderApi *_api = nullptr; //API锟斤拷锟斤拷
    thread _task_thread;                 //锟斤拷锟斤拷锟竭筹拷指锟诫（锟斤拷python锟斤拷锟斤拷锟斤拷锟斤拷锟捷ｏ拷
    TaskQueue _task_queue;               //锟斤拷锟斤拷锟斤拷锟�
    bool _active = false;
    mutex mutex_;
